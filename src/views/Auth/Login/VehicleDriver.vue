  ...
  <div class="flex p-4 md:gap-10 lg:gap-14 items-center">
    ...
    >
      ...
      <h6 class="auth-header mt-16">
        Your vehicle's well-being is your NO 1 priority.
      </h6>
      <p class="py-2 text-lg">
        Drive with confidence knowing your vehicle is in good hands
      </p>
      <div
    ...
    <div class="w-full md:w-6/12 py-8 px-8 md:px-20">
      ...
      <form class="mt-8">
        ...
        <button class="btn-primary w-full mt-8 py-4">Login</button>
      </form>
